Feature: As a manager,
  ...
  Background:
    ...
    And I have shifts:
      ...
      | shift_1_employee_1 | employee_1  | manager_1  | 0.25  | 2016-05-18 14:30:00.000000 | 2016-05-18 20:00:00.000000 |
      | shift_1_employee_2 | employee_2  | manager_1  | 0.25  | 2016-05-18 20:00:00.000000 | 2016-05-19 02:00:00.000000 |
      | shift_2_employee_1 | employee_1  | manager_1  | 0.25  | 2016-05-19 09:00:00.000000 | 2016-05-19 17:00:00.000000 |
      | shift_1_employee_3 | employee_3  | manager_1  | 0.25  | 2016-05-19 12:00:00.000000 | 2016-05-19 18:00:00.000000 |
      | shift_1_employee_4 | employee_4  | manager_1  | 0.5   | 2016-05-20 12:00:00.000000 | 2016-05-20 18:00:00.000000 |
  ...
  by listing shifts within a specific time period in a chronological order.
    ...
    Then The response validates:
      ...
      | shifts.0.shift.start       | Wed, 18 May 16 14:30:00 -0500 | string  |
      | shifts.0.shift.end         | Wed, 18 May 16 20:00:00 -0500 | string  |
      | shifts.0.shift.employee.id | employee_1                    | string  |
      # shift_1_employee_2
      | shifts.1.shift.id          | shift_1_employee_2            | string  |
      | shifts.1.shift.start       | Wed, 18 May 16 20:00:00 -0500 | string  |
      | shifts.1.shift.end         | Thu, 19 May 16 02:00:00 -0500 | string  |
      | shifts.1.shift.employee.id | employee_2                    | string  |
      # shift_2_employee_1
      | shifts.2.shift.id          | shift_2_employee_1            | string  |
      | shifts.2.shift.start       | Thu, 19 May 16 09:00:00 -0500 | string  |
      | shifts.2.shift.end         | Thu, 19 May 16 17:00:00 -0500 | string  |
      | shifts.2.shift.employee.id | employee_1                    | string  |
      # shift_1_employee_3
      | shifts.3.shift.id          | shift_1_employee_3            | string  |
      | shifts.3.shift.start       | Thu, 19 May 16 12:00:00 -0500 | string  |
      | shifts.3.shift.end         | Thu, 19 May 16 18:00:00 -0500 | string  |
      | shifts.3.shift.employee.id | employee_3                    | string  |
      # shift_1_employee_3
      | shifts.4.shift.id          | shift_1_employee_4            | string  |
      | shifts.4.shift.start       | Fri, 20 May 16 12:00:00 -0500 | string  |
      | shifts.4.shift.end         | Fri, 20 May 16 18:00:00 -0500 | string  |
